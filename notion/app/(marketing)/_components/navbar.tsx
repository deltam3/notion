      ...
      <nav className="flex gap-20">
        ...
        <NavigationMenu>
          <NavigationMenuList>
            <NavigationMenuItem>
              <NavigationMenuItem>
                <NavigationMenuTrigger>프로덕트</NavigationMenuTrigger>
                <NavigationMenuContent>
                  <div className="flex ">
            ...
            <NavigationMenuItem>
              <NavigationMenuTrigger>다운로드</NavigationMenuTrigger>
              <NavigationMenuContent>
                <ul className="grid w-[200px] gap-3 p-4 md:w-[500px] md:grid-cols-1 lg:w-[300px]">
                  {downloadMenuList.map((component) => (
                    <ListItem
                      key={component.title}
                      title={component.title}
                      href={component.href}
                ...
                <hr />
                <p className="md:text-[12px] text-gray-700 px-4 py-4">
                  Notion (노션)은{" "}
            ...
            <NavigationMenuItem>
              ...
              <NavigationMenuContent>
                <div className="flex">
                  <div className="">
                    <p className="">팀 규모별 솔루션</p>
                    <ul className="grid w-[200px] gap-3 p-4 md:w-[500px] md:grid-cols-1 lg:w-[300px]">
                      {solutionMenuList.map((component) => (
                        <ListItem
                          key={component.title}
                          title={component.title}
                          href={component.href}
